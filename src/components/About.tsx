...
const About = () => {
  return (
    <section id="about" className="py-20" style={{ backgroundColor: '#b9c3e0ff' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-tp-accent mb-6">About Tech Potato Softwares</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          <div>
            <h3 className="text-3xl font-bold text-tp-text mb-6">Our Story</h3>
            <p className="text-tp-muted mb-6 leading-relaxed">
            ...
            <p className="text-tp-muted mb-8 leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-md">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-tp-light p-4 rounded-lg text-center">
                <div className="text-2xl font-bold text-tp-btn mb-1">200+</div>
                <div className="text-sm text-tp-muted">Projects</div>
              </div>
              <div className="bg-tp-light p-4 rounded-lg text-center">
                <div className="text-2xl font-bold text-tp-accent mb-1">98%</div>
                <div className="text-sm text-tp-muted">Success Rate</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow duration-300">
              <div className="bg-tp-light w-16 h-16 rounded-lg flex items-center justify-center mb-6">
                <item.icon className="text-tp-accent" size={32} />
              </div>
              <h4 className="text-xl font-bold text-tp-text mb-4">{item.title}</h4>
              <p className="text-tp-muted leading-relaxed">{item.description}</p>
            </div>
          ))}
        </div>
      </div>
